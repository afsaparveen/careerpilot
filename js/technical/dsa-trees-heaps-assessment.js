...
async function saveAssessmentResult(
  ...
  /*
   * Unlock the next module only
   * after this assessment is passed.
   */
  ...
  if (passed) {
    ...
    resultTitle.textContent =
      existingResult
        ...
        : "Trees & Heaps Completed!";

    resultMessage.textContent =
      existingResult
        ? "You have already passed this module assessment."
        : "Great work! Module 5 is now unlocked.";
    ...
    resultMessage.textContent =
      `You need at least ${PASS_MARK}/${TOTAL_QUESTIONS} to pass. Review Trees & Heaps and try again.`;
