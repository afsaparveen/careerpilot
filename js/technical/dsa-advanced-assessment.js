...
async function saveAssessmentResult(
  ...
  /*
   * Final module becomes completed
   * only after the assessment is passed.
   */
...
function showResult(
  ...
  if (passed) {
    ...
    resultTitle.textContent =
      existingResult
        ? "DSA Learning Already Completed"
        : "DSA Learning Completed!";

    resultMessage.textContent =
      existingResult
        ? "You have already passed the final DSA module."
        : "Congratulations! You completed all six DSA learning modules.";
    ...
    resultMessage.textContent =
      `You need at least ${PASS_MARK}/${TOTAL_QUESTIONS} to complete the final module. Review the Advanced Problem Solving topics and try again.`;
