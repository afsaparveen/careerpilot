...
async function saveAssessmentResult(
  ...
  /*
   * IMPORTANT:
   * The module becomes completed
   * only when the assessment is passed.
   */
  ...
  if (passed) {
    ...
    resultMessage.textContent =
      existingResult
        ...
        : "Excellent work! Module 2 is now unlocked.";
    ...
    resultMessage.textContent =
      `You need at least ${PASS_MARK}/${TOTAL_QUESTIONS} to pass. Review the DSA Foundations topics and try again.`;
