...
async function saveAssessmentResult(
  ...
  /*
   * Module 5 becomes completed only
   * when the assessment is passed.
   */
  ...
  if (passed) {
    ...
    resultTitle.textContent =
      existingResult
        ...
        : "Graphs Module Completed!";

    resultMessage.textContent =
      existingResult
        ? "You have already passed this module assessment."
        : "Excellent! Module 6 is now unlocked.";
    ...
    resultMessage.textContent =
      `You need at least ${PASS_MARK}/${TOTAL_QUESTIONS} to pass. Review the Graphs topics and try again.`;
