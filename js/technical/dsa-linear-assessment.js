  ...
  if (passed) {
    ...
    resultTitle.textContent =
      existingResult
        ...
        : "Linear Data Structures Completed!";

    resultMessage.textContent =
      existingResult
        ? "You have already passed this module assessment."
        : "Great work! Module 3 is now unlocked.";
    ...
    resultMessage.textContent =
      `You need at least ${PASS_MARK}/${TOTAL_QUESTIONS} to pass. Review the Linear Data Structures topics and try again.`;
